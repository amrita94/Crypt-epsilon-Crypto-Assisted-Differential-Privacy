...
$S$ if there exists  P.P.T algorithms $Sim_1$ and $Sim_2$ such that \begin{gather*} \big\{Sim_1({D_i, i \in S},\mathcal{F}_1(P,\mathcal{D},\Delta,\epsilon)),\mathcal{F}(P,\mathcal{D},\Delta,\epsilon)\big\} \\\stackrel{C}{\equiv} \big\{view^{\Pi}_{Adv1},output^{\Pi}\big\}  \numberthis\label{adv1}
\\ \big\{Sim_2({D_i, i \in S},\mathcal{F}_2(P,\mathcal{D},\Delta,\epsilon)),\mathcal{F}(P,\mathcal{D},\Delta,\epsilon))\big\} \\\stackrel{C}{\equiv}\big\{ view^{\Pi}_{Adv2},output^{\Pi}\big\}  \numberthis\label{adv2}
