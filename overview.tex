...
\am{I think we can drop this next paragraph and include the points to some other place later on.}
...
To summarize, \system is designed to bridge the gap between \cdp and \ldp -- the accuracy and algorithmic expressivity of \cdp with the minimal trust assumptions of \ldp. A comparative analysis of \system, \cdp and \ldp is presented in  Table \ref{DPCompare}.
\begin{table}[t]
	\centering
