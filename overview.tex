...
\stitle{Separation of logical programming framework and physical implementations}: The programming framework (i.e., the set of \system primitives) is independent from the underlying cryptographic primitive specific implementation. This separation between the logical and physical layers allows certain flexibility in the choice for lower level physical implementation details of \system as follows --
