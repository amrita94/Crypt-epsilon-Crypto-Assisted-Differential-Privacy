...
\end{table}
 ...
 \begin{figure}[ht]
   \begin{subfigure}[b]{0.45\linewidth}
    ...
    \end{figure}
\stitle{\system Specific Differentially Private Optimization}
...
\stitle{Crypto-Engineering Optimizations}
