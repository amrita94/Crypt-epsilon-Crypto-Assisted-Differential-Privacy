...
All the programs run on \xh{Ubuntu Linux}. We evaluated our prototype on \xh{xx} servers. The servers each have \xh{xx GB} of memory, ... \xh{did we simulate the communication cost?}
...
\begin{table}
\caption{Execution Time for \system Programs}\label{tab:time}
\centering
\scalebox{0.8}{
\begin{tabular}{|c c|c|c|c|c|}
\hline
